...
- [x] **Tutorial-style getting started.** Сквозной getting-started
  нарратив `docs/tutorial.tex` — от потока-функции до durable-пайплайна
  на одном примере (телеметрия датчиков), 10 шагов. Связывает примеры
  ex01–ex10 единой нитью.
