...
This covers operator-state exactly-once within the engine. End-to-end
exactly-once across an external source/sink (source-offset coordination
plus transactional sink commit) is a deliberate non-goal.
