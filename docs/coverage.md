...
Последний полный замер (на HEAD `9f0e25d`, 120 тест-файлов; с тех пор
набор вырос до 133 файлов, но покрытие заново не пересчитывалось —
цифра ниже ориентировочная, запустите `./scripts/coverage.sh` для
